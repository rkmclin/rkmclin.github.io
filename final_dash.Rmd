...
plot_ly(y = ~snow, color = ~year, type = "box", colors = "viridis") %>% 
  layout(scene = list(yaxis = list(title = "Snowfall in inches"), xaxis = list(title = "Year")))
```
...
noaa_df %>% 
  ...
  layout(scene = list(yaxis = list(title = "Maximum temperature in degrees of Fahrenheit"), xaxis = list(title = "Minimum temperature in degrees of Fahrenheit"))) 
```
...
noaa_df %>%
  ...
  layout(scene = list(yaxis = list(title = "Snow fall in inches"), xaxis = list(title = "Year"))) 
```
